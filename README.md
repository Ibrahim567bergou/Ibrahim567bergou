<h1 align="center">👋 Salut, je suis Ibrahim Bergou</h1>
...
### 🏥 Plateforme de Rendez-vous Médicaux *(e-Ambition)*
> Continuation et évolution d'une plateforme professionnelle de prise de rendez-vous en ligne.
- **Stack** : Java · Spring Boot 3.x · API RESTful · PostgreSQL · SonarQube
- Reprise du code existant, analyse de l'architecture et développement de nouvelles fonctionnalités
- Optimisation de la base de données PostgreSQL · Qualité du code assurée via SonarQube
- Méthodologie **Agile Scrum** : sprint planning, daily stand-up, retrospectives

---

### 👥 [Application de Gestion des Employés](https://github.com/Ibrahim567bergou/Spring-Boot-CRUD-Full-Stack-App)
> Application web full stack avec CRUD complet, authentification et tableaux de bord.
- **Stack** : Java · Spring Boot · Angular · PostgreSQL
- Architecture REST · JWT Authentication · Interface responsive
